...
public abstract class JframeMaker extends JFrame {
    ...
    public JFrame newViewWindow(String viewName, String titleName) {

        newWindow = new JFrame(viewName);
    ...
    private void initializeTitle(JPanel topPanel, JFrame windowName, String titleName) {
